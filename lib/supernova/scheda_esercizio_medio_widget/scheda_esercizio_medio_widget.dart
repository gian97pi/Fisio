/*
*  scheda_esercizio_medio_widget.dart
*  Fisio
*
*  Created by [Author].
...
class SchedaEsercizioMedioWidget extends StatelessWidget {
                ...
                children: [
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: Image.asset(
                        "assets/images/risorsa-1-12.png",
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          height: 227,
                          child: Image.asset(
                            "assets/images/samantha-gades-k95uqdee8r4-unsplash.png",
                            fit: BoxFit.cover,
                          ),
                        ),
                        Align(
                      ...
                      children: [
                        ...
                        Align(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: Color.fromARGB(255, 245, 245, 63),
                              boxShadow: [
                                BoxShadow(
                                  color: Color.fromARGB(41, 0, 0, 0),
                                  offset: Offset(0, 3),
                        ...
                        Align(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: Color.fromARGB(128, 233, 242, 194),
                              boxShadow: [
                                BoxShadow(
                                  color: Color.fromARGB(41, 0, 0, 0),
                                  offset: Offset(0, 3),
